...
/**
 * Copia fiel de advancedsearch/SearchOperation.java de Atlas CMMS
 * (commit 44069b69).
 *
 * Traduce los codigos cortos que manda el navegador ("cn", "eq", "gt"...)
 * al operador que entiende el constructor de consultas.
 */
