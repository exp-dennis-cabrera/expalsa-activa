...
/**
 * Copia fiel de advancedsearch/SpecificationBuilder.java de Atlas CMMS.
 *
 * Junta todas las condiciones de filtro en una sola consulta: las del
 * usuario van unidas por Y, y ademas admite una condicion propia del
 * servidor (por ejemplo, el filtro de visibilidad por subarea).
 */
